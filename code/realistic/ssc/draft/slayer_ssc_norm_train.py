...
def train_model(f):
    ...
    # === Load datasets ===
    train_ds = SpikeDataset(f"/root/autodl-tmp/data_split_norm/train_f{f_str}.h5")
    val_ds   = SpikeDataset(f"/root/autodl-tmp/data_split_norm/val_f{f_str}.h5")
    test_ds  = SpikeDataset(f"/root/autodl-tmp/data_split_norm/test_f{f_str}.h5")
    ...
    torch.save(net.state_dict(), f"slayer_norm_new_f{f_str}.pt")
